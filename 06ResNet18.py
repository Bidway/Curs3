...
def build_resnet18(input_shape, num_classes):
    print("Building ResNet18 manually...")
...
def save_model(model):
    print("Saving model...")
    dirname = f"saved_models/{datetime.now().strftime('%Y%m%d-%H%M%S')}-resnet18-manual"
...
def main():
    ...
    with mlflow.start_run(run_name="resnet18-manual") as run:
        mlflow.log_param("architecture", "Manual ResNet18")
        ...
        model = build_resnet18((IMG_HEIGHT, IMG_WIDTH, 3), N_LABELS)
